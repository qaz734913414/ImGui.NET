...
echo -n "Downloading linux arm64 cimgui: "
curl -sfLo "$SCRIPT_ROOT/deps/cimgui/linux-arm64/cimgui.so" "https://github.com/qaz734913414/ImGui.NET-nativebuild/releases/download/$TAG/cimgui.so"
echo ""
